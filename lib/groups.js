var groups = module.exports = [{
  ...
  items: [
    ...
    {tag: "bulkUpload", deprecated: true},
  ],
}, {
  ...
  items: [
    ...
    {tag: "like"},
    {tag: "uiConf"},
    {tag: "annotation", deprecated: true},
  ],
}, {
  ...
  items: [
    ...
    {tag: "permission"},
    {tag: "permissionItem"},
    {tag: "accessControl", deprecated: true},
    {tag: "adminUser", deprecated: true},
    {tag: "auditTrail", deprecated: true},
  ],
}, {
  ...
  items: [
    {tag: "eventNotificationT emplate"},
    {tag: "scheduledT askProfile"},
    {tag: "integration"},
    {tag: "businessProcessCase"},
    {tag: "notification", deprecated: true},
  ],
}, {
  ...
  label: " Do not show these at all (were completely deprecated and not used anymore anywhere):",
  items: [
    {tag: "document", deprecated: true},
    {tag: "search", deprecated: true},
    {tag: "mixing", deprecated: true},
    {tag: "liveChannel", deprecated: true},
    {tag: "liveChannelSegment", deprecated: true},
  ],
}]
